      ...
      component = React.createClass({
        ...
        render: function() {
          return React.DOM.section({
            ...
            style: {
              top: this.props.header && this.props.header.height && this.props.ads && this.props.ads['banner-top'] ? this.props.header.height + this.props.ads.sizes['banner-top'].height: 0
            }
          }, React.DOM.section({
            id: "content"
          } ) );
