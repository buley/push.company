define([], function() {
  return {
    current: function() {
      ...
      middle_right = sidebar - 140 - box_top_height - box_bottom_height - top_right_height;
      middle_left = left_sidebar - 140 - left_box_top_height - left_box_bottom_height - top_left_height;
