  ...
  return {
    current: function() {
      var padding = {
          ...
          sidebar = padding.top + box_top_height + padding.bottom + padding.top + box_bottom_height,
          left_sidebar = padding.top + left_box_top_height + padding.bottom + padding.top + left_box_bottom_height,
      ...
      if (top_right_height < min_top_right) {
        top_right_height = min_top_right;
      }
      ...
      middle_right = sidebar - 120 - box_top_height - box_bottom_height - top_right_height;
      middle_left = left_sidebar - 120 - left_box_top_height - left_box_bottom_height - top_left_height;
