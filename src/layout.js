  ...
  return {
    current: function() {
      var padding = {
          ...
          left_box_bottom_height = box_bottom_el.offsetHeight ? box_bottom_el.offsetHeight : 0,
          left_box_bottom_width = box_bottom_el.offsetWidth ? box_bottom_el.offsetWidth : 0,
          left_box_top_el = document.getElementById("ads-box-top-left") || {},
          left_box_top_height = box_top_el.offsetHeight ? box_top_el.offsetHeight : 0,
          left_box_top_width = box_top_el.offsetWidth ? box_top_el.offsetWidth : 0,
