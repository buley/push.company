        ...
        render: function() {
          ...
          return React.DOM.section({
            ...
            style: {
              display: current.has_ads && current.has_left ? "inline" : "none",
              "left": padding.left + "px",
              "top": (current.content_top + current.left_box_top_height + current.middle_left + 40 + (current.left_box_top_height > 0 ? padding.bottom : 0) + (current.left_box_top_height > 0 ? padding.top : 0)) + "px" //stream TK
            }
          }, React.DOM.div({
